...
@WebServlet(urlPatterns = "/walidacjaPrzedmiotU")
public class WalidacjaPrzedmiotUpdate extends HttpServlet  {
    ...
    request.getRequestDispatcher("EndEdytujPrzedmiot.jsp").forward(request, response);
	        ...
	        {
	            request.getRequestDispatcher("blad2.jsp").forward(request, response);
	        }
	 }
