...
@WebServlet(urlPatterns = "/walidacjaUczen")
public class WalidacjaUczen extends HttpServlet  {
	    ...
	    protected void doGet(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try
	        {
	        	  Uczen uczen = new Uczen(request.getParameter("imie"),
	                      request.getParameter("nazwisko"), request.getParameter("plec"),  Long.parseLong(request.getParameter("pesel")));
